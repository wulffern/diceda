...
# build directory.
TCL_BUILD_LIB_SPEC='-L/opt/eda/build/tcl8.6.10/unix -ltcl8.6'
...
# compiled.
TCL_SRC_DIR='/opt/eda/build/tcl8.6.10'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/opt/eda/build/tcl8.6.10/unix -ltclstub8.6'
