...
# build directory.
TCL_BUILD_LIB_SPEC='-L$EDA_DIRbuild/tcl8.6.10/unix -ltcl8.6'
...
# compiled.
TCL_SRC_DIR='$EDA_DIRbuild/tcl8.6.10'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L$EDA_DIRbuild/tcl8.6.10/unix -ltclstub8.6'
...
TCL_BUILD_STUB_LIB_PATH='$EDA_DIRbuild/tcl8.6.10/unix/libtclstub8.6.a'
