...
# build directory.
TK_BUILD_LIB_SPEC='-L/opt/eda/build/tk8.6.10/unix -ltk8.6'
...
# compiled.
TK_SRC_DIR='/opt/eda/build/tk8.6.10'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/opt/eda/build/tk8.6.10/unix -ltkstub8.6'
