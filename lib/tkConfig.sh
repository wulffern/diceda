...
# build directory.
TK_BUILD_LIB_SPEC='-L$EDA_DIRbuild/tk8.6.10/unix -ltk8.6'
...
# compiled.
TK_SRC_DIR='$EDA_DIRbuild/tk8.6.10'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L$EDA_DIRbuild/tk8.6.10/unix -ltkstub8.6'
...
TK_BUILD_STUB_LIB_PATH='$EDA_DIRbuild/tk8.6.10/unix/libtkstub8.6.a'
