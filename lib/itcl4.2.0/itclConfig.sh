...
# build directory.
itcl_BUILD_LIB_SPEC='-L$EDA_DIRbuild/tcl8.6.10/unix/pkgs/itcl4.2.0 -litcl4.2.0'
ITCL_BUILD_LIB_SPEC='-L$EDA_DIRbuild/tcl8.6.10/unix/pkgs/itcl4.2.0 -litcl4.2.0'
...
# build directory.
itcl_BUILD_STUB_LIB_SPEC='-L$EDA_DIRbuild/tcl8.6.10/unix/pkgs/itcl4.2.0 -litclstub4.2.0'
ITCL_BUILD_STUB_LIB_SPEC='-L$EDA_DIRbuild/tcl8.6.10/unix/pkgs/itcl4.2.0 -litclstub4.2.0'
...
# String to pass to linker to pick up the Itcl stub library from its
# build directory.
itcl_BUILD_STUB_LIB_PATH='$EDA_DIRbuild/tcl8.6.10/unix/pkgs/itcl4.2.0/libitclstub4.2.0.a'
ITCL_BUILD_STUB_LIB_PATH='$EDA_DIRbuild/tcl8.6.10/unix/pkgs/itcl4.2.0/libitclstub4.2.0.a'
...
itcl_SRC_DIR='$EDA_DIRbuild/tcl8.6.10/pkgs/itcl4.2.0'
ITCL_SRC_DIR='$EDA_DIRbuild/tcl8.6.10/pkgs/itcl4.2.0'

# String to pass to the compiler so that an extension can
# find installed Itcl headers.
itcl_INCLUDE_SPEC='-I$EDA_DIRbuild/tcl8.6.10/pkgs/itcl4.2.0/generic'
ITCL_INCLUDE_SPEC='-I$EDA_DIRbuild/tcl8.6.10/pkgs/itcl4.2.0/generic'
